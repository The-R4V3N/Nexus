...
<style>
  ...
  * { max-width: 100%; }
  ...
  .analysis-text, .evolution-text, .bias-note, .rule-reason, .setup-specs, .disclaimer {
  ...
  @media (max-width: 768px) {
    ...
    .identity-strip { font-size: 10px; padding: 12px 0; }
    .disclaimer { font-size: 10px; padding: 10px 12px; }

    .entry-header { padding: 12px 10px 10px 14px; }
    .entry-title { font-size: 14px; }
    .session-meta { gap: 6px; }
    .session-num { font-size: 9px; }
    .confidence-badge { font-size: 8px; padding: 1px 6px; }

    .bias-line { flex-wrap: wrap; }
    .bias-note { font-size: 10px; }
    .bias-indicator { font-size: 8px; padding: 1px 6px; }

    .entry-grid { grid-template-columns: 1fr; }
    .oracle-col { border-right: none; border-bottom: 1px solid var(--border); }
    .oracle-col, .axiom-col { padding: 12px 10px 12px 14px; }
    .analysis-text, .evolution-text { font-size: 11px; line-height: 1.6; }

    .setups-row { flex-direction: column; }
    .setup-chip { font-size: 9px; padding: 4px 8px; width: 100%; }
    .setup-specs { font-size: 8px; }

    .rule-update { flex-wrap: wrap; font-size: 9px; }
    .rule-reason { flex-basis: 100%; }

    .bias-tag { font-size: 8px; }
    .rule-count { font-size: 8px; }

    footer { font-size: 9px; padding: 14px 0; }
  }
</style>
</head>
<body>
<div class="container">
  ...
  <div class="disclaimer">
    <span class="disclaimer-icon">&#9888;</span> NEXUS is an experimental AI research project. The setups, bias calls, and price levels are generated by a self-evolving algorithm that is still learning. <strong>This is not financial advice.</strong> Do not trade based on NEXUS output without your own independent analysis.
  </div>
